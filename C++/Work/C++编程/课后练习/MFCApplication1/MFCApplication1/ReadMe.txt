...
res\Toolbar.bmp
    此位图文件用于为工具栏创建平铺图像。
    初始工具栏和状态栏在 CMainFrame 类中构造。使用资源编辑器编辑此工具栏位图，并更新 MFCApplication1.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导创建一个视图：

MFCApplication1View.h、MFCApplication1View.cpp - 文档视图
    这些文件包含 CMFCApplication1View 类。
...
MFCApplication1Set.h, MFCApplication1Set.cpp
    这些文件包含 CMFCApplication1Set 类。此类用于访问在向导中选定的数据源。
    不会添加任何序列化支持。
